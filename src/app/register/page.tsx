      ...
      <form onSubmit={handleSubmit} className="mt-8 space-y-4">
        ...
        <Field label={t.auth.mobile}>
          <div className="relative">
            <span className="pointer-events-none absolute inset-y-0 left-0 flex items-center gap-2 pl-3 text-sm font-medium text-slate-500">
              <span>+91</span>
            ...
            <input
              ...
              onChange={(e) => {
                ...
                // Users sometimes type the country code out of habit even
                // though it's already shown as a fixed prefix — strip it
                // rather than reject the number.
        ...
        <div>
          ...
          <div className="relative">
            ...
            <button
              ...
              className="absolute inset-y-0 right-0 z-10 flex items-center px-3 text-slate-500 hover:text-slate-700"
